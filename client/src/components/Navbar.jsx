	...
	return (
		<Navbar {...args}>
			<div id="Navbar" className="flex justify-between w-full h-1/6 ">
				<div onClick={args.showMain} className="text-2xl flex justify-start  ">
				...
				<div className="mr-9 w-3/6 flex justify-end rounded-xl">
					<Button
						onClick={args.showSignup}
						className="rounded-lg mx-3 text-xl normal-case"
					>
						Sign Up
					</Button>
					<Button className="rounded-lg mx-3 text-xl normal-case">About</Button>
					<Button
						onClick={args.showLogin}
						className="rounded-lg mx-4 text-xl normal-case"
					>
						Login
					</Button>
				</div>
